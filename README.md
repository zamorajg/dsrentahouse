...
Nombre del proyecto:  Evaluación Final
Tema: Desarrollo de aplicaciones JEE con Spring Framework
Objetivo del proyecto: Proyecto final del módulo 5, aplicando los conceptos
                       vistos en las sesiones respectivas. Se debe generar una
                       aplicación web basándose en el framework Spring,
...
leyes y normativas que obligan a las empresas a tomartodas las medidas necesarias para proteger
